...
public class CheckInPresImpl extends EntryPresenterImpl {
    private static final String TAG = CheckInPresImpl.class.getSimpleName();

    private EntryContract.EntryView mView;
    private EntryContract.EntryModel mModel;
    private UserData mUserData;

    public CheckInPresImpl(EntryContract.EntryView view) {
        super(view);
        mView = view;
    }
